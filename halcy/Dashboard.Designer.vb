...
Partial Class Dashboard
    ...
    Private Sub InitializeComponent()
        ...
        roleLbl = New Label()
        usnLbl = New Label()
        pfpPct = New Guna.UI2.WinForms.Guna2CirclePictureBox()
        Panel1 = New Panel()
        ...
        itemsPnl = New Panel()
        removeItemBtn = New Guna.UI2.WinForms.Guna2Button()
        editModeBtn = New Guna.UI2.WinForms.Guna2Button()
        addItemBtn = New Guna.UI2.WinForms.Guna2Button()
        refreshBarangBtn = New Guna.UI2.WinForms.Guna2Button()
        searchTxt = New Guna.UI2.WinForms.Guna2TextBox()
        barangDgv = New Guna.UI2.WinForms.Guna2DataGridView()
        ...
        logPnlx = New Panel()
        logRefreshBtn = New Guna.UI2.WinForms.Guna2Button()
        logDgv = New Guna.UI2.WinForms.Guna2DataGridView()
        logNo = New DataGridViewTextBoxColumn()
        logExec = New DataGridViewTextBoxColumn()
        logActions = New DataGridViewTextBoxColumn()
        ...
        userPnl = New Panel()
        userDeleteBtn = New Guna.UI2.WinForms.Guna2Button()
        userEditBtn = New Guna.UI2.WinForms.Guna2Button()
        ...
        Guna2Panel1.Controls.Add(roleLbl)
        ...
        ' pfpPct
        ' 
        pfpPct.FillColor = Color.Silver
        pfpPct.Image = My.Resources.Resources.user
        pfpPct.ImageRotate = 0F
        pfpPct.InitialImage = My.Resources.Resources.user
        pfpPct.Location = New Point(16, 16)
        pfpPct.Name = "pfpPct"
        pfpPct.ShadowDecoration.CustomizableEdges = CustomizableEdges23
        ...
        closeBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges36
        ...
        minBtn.Name = "minBtn"
        minBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges37
        ...
        maxBtn.Name = "maxBtn"
        maxBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges38
        ...
        ' itemsPnl
        ' 
        itemsPnl.Controls.Add(removeItemBtn)
        itemsPnl.Controls.Add(editModeBtn)
        itemsPnl.Controls.Add(addItemBtn)
        itemsPnl.Controls.Add(refreshBarangBtn)
        itemsPnl.Controls.Add(searchTxt)
        itemsPnl.Controls.Add(barangDgv)
        itemsPnl.Location = New Point(176, 32)
        itemsPnl.Name = "itemsPnl"
        itemsPnl.Size = New Size(976, 632)
        itemsPnl.TabIndex = 8
        ' 
        ' removeItemBtn
        ' 
        removeItemBtn.BorderRadius = 15
        removeItemBtn.CustomizableEdges = CustomizableEdges9
        ...
        removeItemBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges10
        ...
        editModeBtn.CustomizableEdges = CustomizableEdges11
        ...
        editModeBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges12
        ...
        addItemBtn.CustomizableEdges = CustomizableEdges13
        ...
        addItemBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges14
        ...
        refreshBarangBtn.CustomizableEdges = CustomizableEdges15
        ...
        refreshBarangBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges16
        ...
        searchTxt.CustomizableEdges = CustomizableEdges17
        ...
        searchTxt.Font = New Font("Poppins", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        searchTxt.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        searchTxt.Location = New Point(24, 0)
        searchTxt.Margin = New Padding(3, 5, 3, 5)
        searchTxt.Name = "searchTxt"
        searchTxt.PasswordChar = ChrW(0)
        searchTxt.PlaceholderText = "Search Item"
        searchTxt.SelectedText = ""
        searchTxt.ShadowDecoration.CustomizableEdges = CustomizableEdges18
        ...
        barangDgv.RowHeadersVisible = False
        barangDgv.Size = New Size(936, 568)
        barangDgv.TabIndex = 0
        barangDgv.Theme = Guna.UI2.WinForms.Enums.DataGridViewPresetThemes.Blue
        barangDgv.ThemeStyle.AlternatingRowsStyle.BackColor = Color.FromArgb(CByte(189), CByte(223), CByte(251))
        barangDgv.ThemeStyle.AlternatingRowsStyle.Font = Nothing
        barangDgv.ThemeStyle.AlternatingRowsStyle.ForeColor = Color.Empty
        barangDgv.ThemeStyle.AlternatingRowsStyle.SelectionBackColor = Color.Empty
        barangDgv.ThemeStyle.AlternatingRowsStyle.SelectionForeColor = Color.Empty
        barangDgv.ThemeStyle.BackColor = Color.White
        ...
        barangDgv.ThemeStyle.RowsStyle.SelectionForeColor = Color.Black
        ' 
        ' no
        ' 
        no.FillWeight = 38.6795425F
        no.HeaderText = "No"
        no.Name = "no"
        no.ReadOnly = True
        ...
        ' itemName
        ' 
        itemName.FillWeight = 228.426361F
        itemName.HeaderText = "Item Name"
        itemName.MinimumWidth = 20
        itemName.Name = "itemName"
        itemName.ReadOnly = True
        itemName.Resizable = DataGridViewTriState.True
        itemName.Width = 200
        ' 
        ' category
        ' 
        category.FillWeight = 90.41343F
        ...
        ' sellPrice
        ' 
        sellPrice.FillWeight = 90.41343F
        ...
        ' logPnlx
        ' 
        logPnlx.Controls.Add(logRefreshBtn)
        logPnlx.Controls.Add(logDgv)
        logPnlx.Location = New Point(176, 32)
        logPnlx.Name = "logPnlx"
        logPnlx.Size = New Size(976, 632)
        logPnlx.TabIndex = 9
        ' 
        ' logRefreshBtn
        ' 
        logRefreshBtn.BackColor = Color.Transparent
        logRefreshBtn.CustomizableEdges = CustomizableEdges39
        ...
        logRefreshBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges40
        ...
        logDgv.Size = New Size(888, 568)
        logDgv.TabIndex = 1
        logDgv.Theme = Guna.UI2.WinForms.Enums.DataGridViewPresetThemes.Blue
        logDgv.ThemeStyle.AlternatingRowsStyle.BackColor = Color.FromArgb(CByte(189), CByte(223), CByte(251))
        logDgv.ThemeStyle.AlternatingRowsStyle.Font = Nothing
        logDgv.ThemeStyle.AlternatingRowsStyle.ForeColor = Color.Empty
        logDgv.ThemeStyle.AlternatingRowsStyle.SelectionBackColor = Color.Empty
        logDgv.ThemeStyle.AlternatingRowsStyle.SelectionForeColor = Color.Empty
        logDgv.ThemeStyle.BackColor = Color.White
        ...
        logDgv.ThemeStyle.RowsStyle.SelectionForeColor = Color.Black
        ' 
        ' logNo
        ' 
        logNo.FillWeight = 38.6795425F
        logNo.HeaderText = "No"
        logNo.Name = "logNo"
        logNo.ReadOnly = True
        logNo.Resizable = DataGridViewTriState.False
        logNo.Width = 33
        ' 
        ' logExec
        ' 
        logExec.FillWeight = 228.426361F
        logExec.HeaderText = "Executor"
        logExec.MinimumWidth = 20
        logExec.Name = "logExec"
        logExec.ReadOnly = True
        logExec.Resizable = DataGridViewTriState.True
        logExec.Width = 120
        ' 
        ' logActions
        ' 
        logActions.HeaderText = "Actions"
        logActions.Name = "logActions"
        logActions.ReadOnly = True
        logActions.Width = 500
        ' 
        ' logTime
        ' 
        logTime.HeaderText = "Time"
        ...
        Guna2Panel2.Controls.Add(logBtn)
        ...
        Logout.CustomizableEdges = CustomizableEdges21
        ...
        Logout.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        Logout.FillColor = Color.Transparent
        Logout.Font = New Font("Poppins", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Logout.ForeColor = Color.Black
        Logout.Image = My.Resources.Resources.logout1
        Logout.ImageAlign = HorizontalAlignment.Left
        Logout.ImageOffset = New Point(5, 0)
        Logout.ImageSize = New Size(26, 26)
        ...
        itemsBtn.CustomizableEdges = CustomizableEdges26
        ...
        itemsBtn.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        itemsBtn.FillColor = Color.Gainsboro
        itemsBtn.Font = New Font("Poppins", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        itemsBtn.ForeColor = Color.Black
        itemsBtn.Image = My.Resources.Resources.box
        itemsBtn.ImageAlign = HorizontalAlignment.Left
        itemsBtn.ImageOffset = New Point(5, 0)
        itemsBtn.ImageSize = New Size(26, 26)
        itemsBtn.Location = New Point(0, 232)
        itemsBtn.Margin = New Padding(0)
        itemsBtn.Name = "itemsBtn"
        itemsBtn.Padding = New Padding(10, 0, 0, 0)
        itemsBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges27
        ...
        logBtn.CustomizableEdges = CustomizableEdges28
        ...
        logBtn.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        logBtn.FillColor = Color.Transparent
        logBtn.Font = New Font("Poppins", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        logBtn.ForeColor = Color.Black
        logBtn.Image = My.Resources.Resources.notes1
        logBtn.ImageAlign = HorizontalAlignment.Left
        logBtn.ImageOffset = New Point(5, 0)
        logBtn.ImageSize = New Size(26, 26)
        logBtn.Location = New Point(0, 176)
        logBtn.Margin = New Padding(0)
        logBtn.Name = "logBtn"
        logBtn.Padding = New Padding(10, 0, 0, 0)
        logBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges29
        logBtn.Size = New Size(176, 56)
        logBtn.TabIndex = 8
        logBtn.Text = "Log"
        logBtn.TextAlign = HorizontalAlignment.Left
        ' 
        ' dashBtn
        ' 
        ...
        dashBtn.CustomizableEdges = CustomizableEdges30
        ...
        dashBtn.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        dashBtn.FillColor = Color.Transparent
        dashBtn.Font = New Font("Poppins", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        dashBtn.ForeColor = Color.Black
        dashBtn.Image = My.Resources.Resources.dashboard
        dashBtn.ImageAlign = HorizontalAlignment.Left
        dashBtn.ImageOffset = New Point(5, 0)
        dashBtn.ImageSize = New Size(25, 25)
        dashBtn.Location = New Point(0, 64)
        dashBtn.Margin = New Padding(0)
        dashBtn.Name = "dashBtn"
        dashBtn.Padding = New Padding(10, 0, 0, 0)
        dashBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges31
        dashBtn.Size = New Size(176, 56)
        dashBtn.TabIndex = 8
        dashBtn.Text = "Dashboard"
        dashBtn.TextAlign = HorizontalAlignment.Left
        ' 
        ' userBtn
        ' 
        ...
        userBtn.CustomizableEdges = CustomizableEdges32
        ...
        userBtn.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        userBtn.FillColor = Color.Transparent
        userBtn.Font = New Font("Poppins", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        userBtn.ForeColor = Color.Black
        userBtn.Image = My.Resources.Resources.profile__1_
        userBtn.ImageAlign = HorizontalAlignment.Left
        userBtn.ImageOffset = New Point(5, 0)
        userBtn.ImageSize = New Size(27, 27)
        userBtn.Location = New Point(0, 120)
        userBtn.Margin = New Padding(0)
        userBtn.Name = "userBtn"
        userBtn.Padding = New Padding(10, 0, 0, 0)
        userBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges33
        userBtn.Size = New Size(176, 56)
        userBtn.TabIndex = 8
        userBtn.Text = "User Settings"
        userBtn.TextAlign = HorizontalAlignment.Left
        ' 
        ' userPnl
        ' 
        userPnl.Controls.Add(userDeleteBtn)
        userPnl.Controls.Add(userEditBtn)
        userPnl.Controls.Add(addUserBtn)
        userPnl.Controls.Add(Guna2Button2)
        userPnl.Controls.Add(userDgv)
        userPnl.Location = New Point(176, 32)
        userPnl.Name = "userPnl"
        userPnl.Size = New Size(976, 632)
        userPnl.TabIndex = 9
        ' 
        ' userDeleteBtn
        ' 
        ...
        userDeleteBtn.Location = New Point(264, 0)
        ...
        userEditBtn.CustomizableEdges = CustomizableEdges3
        ...
        userEditBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges4
        ...
        addUserBtn.CustomizableEdges = CustomizableEdges5
        ...
        addUserBtn.ShadowDecoration.CustomizableEdges = CustomizableEdges6
        ...
        Guna2Button2.Image = My.Resources.Resources.reload
        Guna2Button2.Location = New Point(696, 8)
        Guna2Button2.Name = "Guna2Button2"
        Guna2Button2.ShadowDecoration.CustomizableEdges = CustomizableEdges8
        Guna2Button2.Size = New Size(24, 24)
        ...
        userDgv.Columns.AddRange(New DataGridViewColumn() {userNo, userName, userRole, userCreated})
        ...
        userDgv.Size = New Size(696, 568)
        userDgv.TabIndex = 2
        userDgv.Theme = Guna.UI2.WinForms.Enums.DataGridViewPresetThemes.Blue
        userDgv.ThemeStyle.AlternatingRowsStyle.BackColor = Color.FromArgb(CByte(189), CByte(223), CByte(251))
        userDgv.ThemeStyle.AlternatingRowsStyle.Font = Nothing
        ...
        userDgv.ThemeStyle.RowsStyle.SelectionForeColor = Color.Black
        ' 
        ' userNo
        ' 
        userNo.FillWeight = 38.6795425F
        userNo.HeaderText = "No"
        userNo.Name = "userNo"
        userNo.ReadOnly = True
        userNo.Resizable = DataGridViewTriState.False
        userNo.Width = 33
        ' 
        ' userName
        ' 
        ...
        ' userCreated
        ' 
        userCreated.HeaderText = "Created At"
        userCreated.Name = "userCreated"
        userCreated.ReadOnly = True
        userCreated.Width = 210
        ' 
        ' Dashboard
        ' 
        ...
        CType(pfpPct, ComponentModel.ISupportInitialize).EndInit()
        Panel1.ResumeLayout(False)
        itemsPnl.ResumeLayout(False)
        CType(barangDgv, ComponentModel.ISupportInitialize).EndInit()
        logPnlx.ResumeLayout(False)
    ...
    Friend WithEvents pfpPct As Guna.UI2.WinForms.Guna2CirclePictureBox
    ...
    Friend WithEvents refreshBarangBtn As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents removeItemBtn As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents editModeBtn As Guna.UI2.WinForms.Guna2Button
    ...
    Friend WithEvents buyPrice As DataGridViewTextBoxColumn
    ...
    Friend WithEvents userNo As DataGridViewTextBoxColumn
    ...
    Friend WithEvents logPnlx As Panel
    Friend WithEvents logRefreshBtn As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents logDgv As Guna.UI2.WinForms.Guna2DataGridView
    Friend WithEvents logNo As DataGridViewTextBoxColumn
    Friend WithEvents logExec As DataGridViewTextBoxColumn
    Friend WithEvents logActions As DataGridViewTextBoxColumn
    Friend WithEvents logTime As DataGridViewTextBoxColumn
    Friend WithEvents logId As DataGridViewTextBoxColumn
    Friend WithEvents userDeleteBtn As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents userEditBtn As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents addUserBtn As Guna.UI2.WinForms.Guna2Button
End Class
